...
/***/ 230:
/*!********************************************!*\
  !*** ./app/javascript/packs/games/edit.js ***!
  \********************************************/
/*! no exports provided */
/*! all exports used */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(/*! axios */ 16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_dom_utils_js__ = __webpack_require__(/*! ../../src/dom_utils.js */ 231);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  for (let select of selects) {
    select.addEventListener('change', async e => {
      ...
      const res = await __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(`/api/v1/teams/${teamId}`);

      const dataSelect = e.target.getAttribute('data_select');
      const selectToUpdate = qs(`[data_to_update="${dataSelect}"]`);

      Object(__WEBPACK_IMPORTED_MODULE_1__src_dom_utils_js__["a" /* updatePlayerSelect */])(selectToUpdate, res.data.players);
    });
  }
});
...
/***/ 231:
/*!*****************************************!*\
  !*** ./app/javascript/src/dom_utils.js ***!
  \*****************************************/
/*! exports provided: updatePlayerSelect */
/*! exports used: updatePlayerSelect */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = updatePlayerSelect;
/**
 ...
 */
function updatePlayerSelect(select, options) {
  const optionElms = [];
...
/******/ });
//# sourceMappingURL=edit-f5d1b7fb429c0b576cdb.js.map